    ...
    <>
      ...
      <main style={{ paddingTop: "62px" }}>
        ...
        >
          ...
          >
            Web design, SEO, and brand strategy — written for business owners
        ...
        <section
          style={{
            maxWidth: "1180px",
            margin: "0 auto",
            padding: "clamp(40px,5vw,64px) clamp(20px,5vw,64px) clamp(64px,8vw,120px)",
          }}
        >
          {posts.length === 0 ? (
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <h2
                    ...
                    className="group-hover:text-[#B5642E]"
                  >
                    {post.title}
                  </h2>
